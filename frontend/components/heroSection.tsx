...
export default function HeroSection() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const payload = {
      orgName: formData.get("orgName") || "Unnamed Org",
      email: formData.get("email") || `test_${Date.now()}@test.com`,
      state: formData.get("state") || "Delhi",
      focusAreas: selectedFocusAreas || [], // This MUST be an array
      // Fill the rest with empty strings if blank to satisfy the DB
      ...
      operatingDistricts: formData.get("operatingDistricts") || "",
    };
